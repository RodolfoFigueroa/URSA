...
def generate_drive_text_translation_land(how, where):
    return html.Div(
        [
            ...
            dbc.Card(
                dbc.CardBody(
                    [html.H5(id="generate-drive-text3-land"), html.P(id="WHERE-land")]
                ),
                class_name="supp-info",
            ),
            dbc.Card(
                dbc.CardBody(
                    [
                        html.H5(id="generate-drive-text4-land"),
                        html.Span(id="generate-drive-text5-land"),
                        html.Ul(
                            [
                                html.Li(
                                    [
            ...
            dbc.Card(
                dbc.CardBody(
                    [
                        html.H5(id="generate-drive-text13-land"),
                        html.Span(id="generate-drive-text14-land"),
                    ]
                ),
                class_name="supp-info",
            ),
